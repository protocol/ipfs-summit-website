      ...
      <React.Fragment>
        ...
        <div className={STYLES_SECTION}>
          ...
          <P>
            ...
            should feel welcome, safe and comfortable to share ideas and engage
            in open discussion. The IPFS Pinning Summit is dedicated to
            providing a harassment-free experience for everyone inclusive of
            gender, gender identity and expression, sexual orientation,
            disability, physical appearance, body size, race, age, nationality
            or religion.
          </P>
          <P>
            All participants, speakers, sponsors and staff are required to abide
            by our Code of Conduct at the IPFS Pinning Summit. Any violations
            will be dealt with seriously and may include being expelled and
            banned from the event and its online space. This is to protect the
            safety of our community and attendees.
          </P>
          <H2>Definitions</H2>
          <P>
            What do we mean by “harassment”? Harassment includes but isn’t
            limited to:
          </P>
          <UL>
            <LI>
              ...
              neurotype, physical appearance, body size, race, age, nationality,
              religion or belief, marital and civil partnership status,
              pregnancy or carer or parental status, familial status, veteran
          ...
          <P>
            Participants engaging in harassing behavior may be asked to leave
            the event and online space and may be banned temporarily or
            indefinitely.
          </P>
          <P>
            If harassment occurs outside an event or online space organised by
            the IPFS Pinning Summit that may impact the safety of our community,
            we reserve the right to investigate and take appropriate action, for
            instance banning from future events.
          </P>
          <H2>Reporting</H2>
          <P>
            If you are being harassed or made to feel unsafe or unwelcome,
            please report it as soon as possible. You can help us by reporting
            any behavior you think might go against the Code of Conduct.
          </P>
          <P>
          ...
          <UL>
            <LI>
              {" "}
              Incident report is taken in a safe, private space at events or in
              a personal and direct message online.
            </LI>
            <LI> Incident responders investigate with the reported person.</LI>
            <LI>
              {" "}
              Incident response team reconvene to discuss an appropriate
              response.
            </LI>
